	    ...
	    <div class="container">
	      ...
	      <div class="site-header__menu group">
	            ...
	            <li
					<?php 
						if (get_post_type() == 'post')
							echo 'class="current-menu-item"';
					?>
	            	><a href="<?php echo esc_url(site_url('/blog')); ?>">Blog</a></li>
	          </ul>
	        </nav>
	        <div class="site-header__util">
				...
				?>
						<a href="<?php echo esc_url(site_url('/my-notes')); ?>" class="btn btn--small  btn--dark-orange float-left push-right">My Notes</a>
